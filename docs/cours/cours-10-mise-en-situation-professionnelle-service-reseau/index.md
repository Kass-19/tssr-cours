...
<div id="quiz-cours-10-mise-en-situation-professionnelle-service-reseau"></div>

<script type="application/json" id="quiz-cours-10-mise-en-situation-professionnelle-service-reseau-data">
[
  {
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    TSSRQuiz.init({
      containerId: "quiz-cours-10-mise-en-situation-professionnelle-service-reseau",
      dataId: "quiz-cours-10-mise-en-situation-professionnelle-service-reseau-data",
    });
  });
</script>
