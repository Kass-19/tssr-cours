...
<div id="quiz-cours-09-les-services-reseau-en-environnement-linux-module-6-dhcp"></div>

<script type="application/json" id="quiz-cours-09-les-services-reseau-en-environnement-linux-module-6-dhcp-data">
[
  {
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    TSSRQuiz.init({
      containerId: "quiz-cours-09-les-services-reseau-en-environnement-linux-module-6-dhcp",
      dataId: "quiz-cours-09-les-services-reseau-en-environnement-linux-module-6-dhcp-data",
    });
  });
</script>
